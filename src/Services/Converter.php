<?php
namespace Kyawnaingtun\Tounicode\Services;
...
class Converter{
    ...
    public static function convert($value){
        $inputValue = self::checkFontType($value);
        if($inputValue == "zg" || $inputValue == "mm") {
            return self::replaceWithRule($value);
        }else{
     ...
     * @return [string]        [output unicode]
     */
    public static function replaceWithRule($outputValue)
    {
        $rule = [
            ["from" => "(\u103D|\u1087)","to" =>"\u103E"],
            ["from" => "\u103C","to" =>"\u103D"],
